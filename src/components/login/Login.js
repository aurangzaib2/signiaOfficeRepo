            ...
            <Grid container>
                ...
                <Grid md={6}>
                    <div className="btn-wrap">
                        <Link className="buttonadmin" to = '/adminlogin'> Administrator Login </Link>
                    </div>
                </Grid>
            </Grid>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <form className="page-form login-page">
                            ...
                            <div className="form-group align-center" >
                                <input onChange={textHandler} type="email" value={email} name="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="User ID / Email" />
                            </div>
                            <Typography
                                ...
                                <br />
                            <div className="form-group align-center">
                                <input onChange={textHandler} placeholder="Password" value={password} name="password" type="password" className="form-control" id="exampleInputPassword1" />
                            </div>
                            <Typography
                                    className="errPadding"
                                    component="p"
